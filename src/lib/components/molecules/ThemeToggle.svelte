<script lang="ts">
	...
	import TriangleOpen from "$lib/icons/TriangleOpen.svelte";
...
<style lang="scss">
	.theme-toggle {
		...
		&:hover {
			...
			#moon,
			#sun {
				fill: rgba(0, 173, 181, 1);
				> * {
					filter: drop-shadow(0px 0px 1px rgba(0, 173, 181, 0.5));
				}
			}
	...
	#moon > circle {
		transition: all 0.25s var(--ease-out-3);
	}
